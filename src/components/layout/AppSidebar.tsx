...
export function AppSidebar() {
  ...
  const { sidebarAcik, toggleSidebar } = useUIStore();

  return (
    <aside
      className={cn(
        "flex flex-col h-full border-r bg-sidebar transition-all duration-300 ease-in-out shrink-0",
